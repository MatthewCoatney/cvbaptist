...
<head>
  ...
  <link rel="stylesheet" href="player/howler-styles.css">
</head>
<body>
  <!-- Top Info -->
  <div id="title">
  ...
  <!-- Scripts -->
  <script src="player/howler.core.min.js"></script>
...
// PagesController::howler returns JSON
var player = new Player({!! str_replace('&quot;', '"', $sermons) !!});
/*
  // Setup our new audio player class and pass it the playlist.
